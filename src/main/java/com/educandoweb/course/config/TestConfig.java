...
public class TestConfig implements CommandLineRunner {
    @Autowired //aqui o spring entende que deve resolver essa dependecia instanciando meu UserRepository
    ...
    public void run(String... args) throws Exception {
        ...
        //aqui eu associo meu primeiro livro com a segunda categoria, fazendo com que meu p1, seja adicionado na categoria 2
        ...
        //aqui eu salvo todas as associações feitas
        productRepository.saveAll(Arrays.asList(p1, p2, p3, p4, p5));
        ...
        //aqui tenho tres pedidos, cada um deles marcam o instante no padrao UTC e estao linkados com um usuario
